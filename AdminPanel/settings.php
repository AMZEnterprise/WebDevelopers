        ...
        <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="NavbarTop">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item active"><a href="settings.php" class="nav-link"><span class="fa fa-cogs"></span> تنظیمات</a></li>
                </ul>
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="settings.php" class="dropdown-item disabled"><i class="fa fa-cog mr-3"></i>تنظیمات</a>
                        </div>
                    </li>
        ...
        <div class="container-fluid">
            <div class="row text-white">
                <div class="col text-center py-5">
                    <h2><span class="fa fa-cogs"></span> تنظیمات</h2>
                </div>
            </div>
        </div>
    </section>
